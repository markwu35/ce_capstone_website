...
const About = () => (
    ...
    <div className="header-img">
      <img src={header} />
		...
		<div className="row">
      <div className="col s4"><img className="about-image" src={hyperloop2014} /></div>
      ...
      <div className="col s4"><img className="about-image" src={about2} /></div>
		</div>
		<div className="row">
      <div className="col s4"><img className="about-image" src={about3} /></div>
      <div className="col s8">
      ...
      <div className="col s4"><img className="about-image" src={about4} /></div>
		</div>

		<div id="sponsors_section">
			<h4>Sponsors</h4>
			<div className="row">
